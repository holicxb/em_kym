...
public class Towers extends JFrame {
	...
	private String[] upgradePrice; // 업그레이드 가격
	private int level; // 타워 레벨
	private int[] yX_index; // 타워 인덱스
	private int[][] rangePixel; // 전장에 출력될 픽셀 값
	private int sell; // 타워 판매값
	private boolean atkCooldown; // 공격 쿨타임
	private int atkTerm; // 쿨타임 주기
	private int changeImg; // 공격 모션 이미지 결정 값
